...
CREATE TABLE IF NOT EXISTS `pethealth`.`vaccine` (
  ...
  PRIMARY KEY (`uuid`),
  INDEX `index2` (`recall_time_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `pethealth`.`pet_type` (
  ...
  `rec_st` VARCHAR(45) NOT NULL DEFAULT 'C',
  PRIMARY KEY (`uuid`),
  INDEX `index2` (`vaccin_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `pethealth`.`pet` (
  ...
  `date_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `rec_st` VARCHAR(1) NOT NULL DEFAULT 'DEFAULT \'C\'',
  PRIMARY KEY (`uuid`),
  INDEX `index2` (`user_id` ASC) VISIBLE,
  INDEX `index3` (`pet_race_id` ASC) VISIBLE,
  INDEX `index4` (`pet_type_id` ASC) VISIBLE,
  CONSTRAINT `fk_pet_1`
    FOREIGN KEY (`user_id`)
...
CREATE TABLE IF NOT EXISTS `pethealth`.`health_book_main` (
  ...
  `date_time` DATE NULL,
  PRIMARY KEY (`uuid`),
  INDEX `index2` (`pet_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `pethealth`.`health_book_detail` (
  ...
  PRIMARY KEY (`uuid`),
  INDEX `index2` (`vaccin_id` ASC) VISIBLE,
  INDEX `index3` (`pest_control_id` ASC) VISIBLE,
  INDEX `index4` (`health_book_main_id` ASC) VISIBLE,
