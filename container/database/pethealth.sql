...
<<<<<<< HEAD
-- Wed Apr 10 18:39:53 2019
=======
-- Sat Apr  6 21:37:39 2019
>>>>>>> develop
...
CREATE TABLE IF NOT EXISTS `pethealth`.`pet` (
  ...
  PRIMARY KEY (`uuid`),
  INDEX `fk_pet_3_idx` (`pet_race_id` ASC),
  INDEX `fk_pet_2_idx` (`pet_type_id` ASC),
  INDEX `fk_pet_1_idx` (`user_id` ASC),
  CONSTRAINT `fk_pet_3`
...
CREATE TABLE IF NOT EXISTS `pethealth`.`health_book_main` (
  ...
  PRIMARY KEY (`uuid`),
  INDEX `index2` (`uuid` ASC),
  INDEX `fk_health_book_main_1_idx` (`pet_id` ASC),
...
CREATE TABLE IF NOT EXISTS `pethealth`.`health_book_detail` (
  ...
  PRIMARY KEY (`uuid`),
  INDEX `index2` (`uuid` ASC),
  INDEX `fk_health_book_detail_2_idx` (`vaccin_id` ASC),
  INDEX `fk_health_book_detail_3_idx` (`pest_control_id` ASC),
  INDEX `fk_health_book_detail_1_idx` (`health_book_main_id` ASC),
